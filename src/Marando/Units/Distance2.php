...
class Distance2
{
     ...
     */
    public function add(Distance2 $b)
    {
        return Distance2::m(bcadd($this->m, $b->m), static::$s);
    }
     ...
     * with the difference.
     *
     * @param Distance2 $b Distance to subtract
     *
     * @return static Difference of the two distances
     */
    public function sub(Distance2 $b)
    {
        return Distance2::m(bcsub($this->m, $b->m), static::$s);
    }
